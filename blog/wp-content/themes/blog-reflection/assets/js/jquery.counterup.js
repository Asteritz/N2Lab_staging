...
!(function () {
                ...
                (t = {
                    ...
                    for (var a in this.waypoints[r]) {
                        ...
                        p.element !== p.element.window && (y = p.adapter.offset()[s.offsetProp]),
                            ...
                            (c = !h && !u),
                            !w && h && u ? (p.queueTrigger(s.backward), (o[p.group.id] = p.group)) : ((!w && c) || (w && s.oldScroll >= p.triggerPoint)) && (p.queueTrigger(s.forward), (o[p.group.id] = p.group));
                    }
                }
                return (
    ...
    (function (t) {
        ...
        t.fn.counterUp = function (e) {
            var i,
                o = t.extend({ time: 400, delay: 10, offset: 100, beginAt: 0, formatter: !1, context: "window", callback: function () {} }, e);
                            ...
                            e.data("counterup-func", function () {
                                e.data("counterup-nums")
                                    ? (e.html(e.data("counterup-nums").shift()),
                                      e.data("counterup-nums").length ? setTimeout(e.data("counterup-func"), n.delay) : (e.data("counterup-nums", null), e.data("counterup-func", null), o.callback.call(this)))
